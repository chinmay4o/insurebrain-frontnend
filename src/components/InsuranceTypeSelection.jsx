    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 mb-6">
          <div className="flex items-center gap-2 bg-red-100 text-red-600 px-2 py-1 rounded-full text-xs font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
          {insuranceTypes.map((insurance) => {
            ...
            return (
              ...
              >
                {/* Colored header */}
                <div className={`h-20 ${insurance.bgColor} relative`}>
                ...
                <div className="p-5">
                  ...
                  {insurance.available ? (
                    ...
                    <Button 
                      disabled
                      className="w-full bg-gray-100 text-gray-500 font-medium py-2 text-sm cursor-not-allowed"
                    >
                      Coming Soon
                    </Button>
                  )}
